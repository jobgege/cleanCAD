import { RectType, TriangleType, LineType, ComponentType } from "./type";
...
class Diagram {
  ...
  // 辅助函数：检查点是否在组件内
  isPointInComponent(mouseX, mouseY, component:ComponentType) {
  ...
  // 辅助函数：检查点是否在引脚上
  isPointInPin(mouseX, mouseY, pin, component:ComponentType) {
